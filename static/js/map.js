...
//             var eventLink = "{{ url_for('location', location_id=locationId) }}";
//             var singleEventLink = eventLink.concat(locationId);
//             var infoContent =

//                 '<div id="iw-container">' +
//                 '<a href='+singleEventLink+'><span class="card-link"></span></a>' +
